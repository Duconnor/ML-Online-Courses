...
class ReplayBuffer(object):
    ...
    def add_rollouts(self, paths, concat_rew=True):
        ...
        observations, actions, rewards, next_observations, terminals = convert_listofrollouts(
            paths, concat_rew)
        ...
        if self.obs is None:
            ...
            # Here we concatenate the new observations at the back of the
            # of self.obs and pick the last self.max_size from it
