...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size):
        ...
        if itr == 0:
            # Need to load initial training data
        ...
        # Each element in the batch is a training example (one simulation) and has it own env steps
        # envsteps_this_batch is the summation of each element's env steps in this batch
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            self.agent.train(ob_batch, ac_batch, re_batch,
