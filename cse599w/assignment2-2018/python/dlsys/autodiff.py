...
class AddByConstOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_elemwise_add_by_const(input_shapes[0], node.const_val, tgt, tgt_host, 'elem_add_by_const')
...
class MulByConstOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_elemwise_mul_by_const(input_shapes[0], node.const_val, tgt, tgt_host, 'elem_mul_by_const')
...
class MatMulOp(Op):
    ...
    def infer_shape(self, node, input_shapes):
        ...
        A_shape = (input_shapes[0][1], input_shapes[0][0]) if node.matmul_attr_trans_A else input_shapes[0]
        B_shape = (input_shapes[1][1], input_shapes[1][0]) if node.matmul_attr_trans_B else input_shapes[1]
...
class SoftmaxCrossEntropyOp(Op):
    ...
    def infer_shape(self, node, input_shapes):
        """TODO: Your code here"""
        return (1,) # Cross Entropy is a loss function, the result is a scalar
...
class ReluGradientOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm.make_relu_gradient(input_shapes[0], tgt, tgt_host, 'relu_gradient')
...
class Executor(object):
    ...
    def infer_shape(self, feed_shapes):
        ...
        """
        """TODO: Your code here"""
        for feed_node, feed_shape in feed_shapes:
            self.node_to_shape_map[feed_node] = feed_shape
    ...
    def memory_plan(self, feed_shapes):
        ...
        for node in self.topo_order:
            if node in feed_shapes:
                continue # No need to allocate memory for feed_dict nodes
    ...
    def compile_funcs(self, feed_shapes):
        ...
        for node in self.topo_order:
            if node in feed_shapes:
                continue # No need to compile placeholder op
